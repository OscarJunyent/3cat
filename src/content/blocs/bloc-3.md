...
commands:
  - label: "Clonar el repositori del taller amb branca mpc"
    language: "bash"
    code: "git clone https://github.com/Formacio-3Cat/3cat-shows-api/tree/mcp"
  - label: "Repositori MCP Wikipedia"
    language: "bash"
    code: "git clone https://github.com/Formacio-3Cat/3cat-wikipedia-mcp""
  - label: "Repositori MCP TV Maze"
    language: "bash"
    code: "git clone https://github.com/Formacio-3Cat/3cat-tvmaze-mcp"
practiceExercise:
